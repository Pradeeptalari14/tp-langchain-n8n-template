...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/langchain-n8n-template/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-langchain-n8n-template.git
cd tp-langchain-n8n-template
```
...
```bash
kubectl port-forward deployment/tp-langchain-n8n-template 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── workflow_cache.json     # Main configuration file
```
...
---
*Generated by [LangChain + n8n Template Studio](https://pradeeptalari14.github.io/portfolio/tools/langchain-n8n-template/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
