# 🔧 Troubleshooting Guide — LangChain + n8n Template
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-langchain-n8n-template/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/langchain-n8n-template/)
